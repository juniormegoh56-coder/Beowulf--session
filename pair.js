        ...
        try {
            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://kommodo.ai/i/aUZYFgE1o7IllgUCGDOV")
                        ? 'GENTILL-MD-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
🔗 *Join Our Support Channel:* 👉 [Click Here to Join](https://chat.whatsapp.com/BZpdBg15sEb3omFuxovhnN?mode=gi_tchannel/0029Vac8SosLY6d7CAFndv3Z) 

⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [junior megoh GitHub Repo](https://github.com/juniormegoh/)  

🚀 _Thanks for choosing GENTILL-MD — Let the automation begin!_ ✨`;
